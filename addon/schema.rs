// This code will ultimately be read and processed by `codegen.py` to create Lua serialization code and Rust deserialization code.
// For now, a first pass, it's done manually and changes must be manually "code-genned"

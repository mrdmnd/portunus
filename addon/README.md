...
In my case, I play on ultrawide 3440 x 1440p. The default y-resolution for the game is 768, so the correct UI scale for me is 768 / 1440 = 0.53333333333. Becaues the game limits the settings on the "UIScale" cvar to things above 0.64, we need to set the UIParent directly.

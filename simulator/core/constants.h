...
*/
static constexpr std::map<Specialization, std::vector<double>> kMasteryCoeffs =
    {
...
static constexpr std::map<Specialization, std::array<int, 4>> kBaseStats = {
...
static constexpr std::map<Race, std::array<int, 4>> kRaceStatMods = {
...
static constexpr std::map<Specialization, int> kBaseMana = {
